...
* **Live Coding Practice (No IDE):** Once a week, practice writing syntactically correct Python (with exact import syntax) in a plain text editor or Google Doc to prepare for IDE-less live coding interviews.
...
Evaluation,"Run Ragas/W\&B harness, apply OWASP fixes, and record a video walkthrough.",
